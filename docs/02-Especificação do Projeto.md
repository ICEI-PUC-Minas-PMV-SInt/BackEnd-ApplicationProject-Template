...
|RF-007| Enviar notificações aos usuários para lembrá-los de de realizar seus treinos, acompanhar seu progresso.  | MÉDIA |  
...
|ID     | Descrição do Requisito  |Prioridade |
|-------|-------------------------|----|
|RNF-001| A aplicação deve ser responsiva e responder às ações do usuário em no máximo 2s. | ALTA | 
|RNF-002| A aplcação deve estar disponível online 99% do tempo , minimizando falhas e interrupções para que os usuários possam acessar os exercícios sem problemas.  |  MÉDIA | 
|RNF-003| A aplicação deve estar em conformidade com regulamentos de privacidade de dados, como LGPD, para que os dados dos usuários sejam armazenados e utilizados de forma ética e transparente.  | ALTA |
...
|RNF-005| A aplcação deve ser facilmente mantida e atualizada, com código limpo e modular.  | ALTA | 
